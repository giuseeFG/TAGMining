...
fs.createReadStream('/Volumes/MacbookHD/Documenti/MYSTUFF/RM3/2nd/AGIW/00new.warc')
	...
	.on('data', function(data) {
	   ...
	   //  			}); 
				...
				// 	fs.appendFile('/Volumes/MacbookHD/Documenti/MYSTUFF/RM3/2nd/AGIW/TAGMining/OUT1.txt', doc.trec_id + "\t\t" + matchEMAIL + "\t\t" + '#EMAIL' + "\n", function (err) {
		  //   			if(err) {
	   //  	    			return console.log(err + "ERRORE");
	   //  				}
	   ...
	   //  			}); 
				...
				// 	fs.appendFile('/Volumes/MacbookHD/Documenti/MYSTUFF/RM3/2nd/AGIW/TAGMining/OUT1.txt', doc.trec_id + "\t\t" + matchURL + "\t\t" + '#URL' + "\n", function (err) {
		  //   			if(err) {
	   //  	    			return console.log(err + "ERRORE");
	   //  				}
